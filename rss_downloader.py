            ...
            if keep_latest:
                ...
                if episodes:
                    ...
                    if os.path.exists(temp_filename):
                        while is_file_in_use(download_path):
                            print(f"File {output_filename} is in use, waiting...")
                            time.sleep(10)
            ...
            if keep_weekdays:
                ...
                for day, filename in weekday_filenames.items():
                    ...
                    if episodes:
                        ...
                        if os.path.exists(temp_filename):
                            while is_file_in_use(download_path):
                                print(f"File {weekday_filename} is in use, waiting...")
                                time.sleep(10)
            ...
            if keep_latest_n > 0:
                ...
                if episodes:
                    ...
                    for i, (mp3_url, episode_title, published_date, latest_entry, duration_seconds) in enumerate(episodes[1:], start=1):
                        ...
                        if os.path.exists(temp_filename):
                            while is_file_in_use(download_path):
                                print(f"File {output_filename_n} is in use, waiting...")
                                time.sleep(10)
